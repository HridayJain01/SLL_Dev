...
export default function FAQ() {
  const faqs = [
    ...
    { q: "Can I upgrade my plan later?", a: "Yes, you can move from Little Reader to Star Reader or Wonder Bundle anytime. Message us on WhatsApp and we will help with the upgrade." },
    { q: "Are puzzles included in all plans?", a: "Puzzles are available on Star Reader, while Wonder Bundle includes a dedicated monthly puzzle allowance. Little Reader is books-only." },
  ];
